...
export default function Navbar() {
  return (
    <header className="relative w-full z-50">
      <div className="max-w-[1120px] mx-auto px-6 pt-6 pb-2 flex items-center justify-between">
        <div className="flex items-center gap-8">
          <Link
            href="/"
            className="font-semibold text-[16px] tracking-[-0.02em] text-text-primary"
          >
            openenv
          </Link>
          <nav className="hidden md:flex items-center gap-6">
            ...
            <a
              href="https://github.com/Sparkyyy45/openenv#readme"
              target="_blank"
              rel="noreferrer"
              className="text-[14px] font-medium text-text-secondary hover:text-text-primary transition-colors"
            >
